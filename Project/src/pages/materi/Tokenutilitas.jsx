  ...
  return (
    ...
    <div className="flex justify-center items-center h-[15vh]">
      <div className="h-[60px] w-[200px] dekstop:w-[500px] laptop:w-[400px] tablet:w-[300px] bg-slate-50 text-center rounded-2xl shadow-xl border-2 border-gradient-to-r from-purple-500 to-indigo-500 hover:shadow-indigo-500/50 transform hover:scale-105 transition duration-300 ease-in-out">
        <h1 className="text-black text-2xl dekstop:text-6xl laptop:text-5xl tablet:text-4xl font-extrabold gradient-judul tracking-wide">Token Utilitas</h1>
      </div>
    </div>
      ...
      <div className="flex flex-col items-center h-auto w-full dekstop:w-[1150px] laptop:w-[1000px] bg-slate-100 mt-6 dekstop:mt-12 laptop:mt-8 mb-12 p-4 dekstop:p-6 laptop:p-5 rounded-xl shadow-lg">
        <h2 className="text-gray-800 text-2xl dekstop:text-3xl laptop:text-2xl font-semibold mb-4 text-center">Apa itu Token Utilitas ?</h2>
  ...
  <img src={tokenutilitas} alt="DEFI" className="w-full h-full object-contain" />
         ...
         <div className="flex flex-wrap justify-around w-full gap-4 mb-6">
          <div className="w-full dekstop:w-[48%] laptop:w-[48%] bg-gradient-to-r from-slate-50 via-gray-200 to-slate-50 p-4 dekstop:p-6 laptop:p-6 rounded-lg shadow-md">
            <h3 className="text-gray-800 text-xl dekstop:text-2xl laptop:text-2xl font-semibold mb-2">Akses ke Layanan atau Produk di Platform Blockchain</h3>
            ...
            Token utilitas sering digunakan sebagai "kunci" untuk mengakses layanan atau fitur khusus pada platform berbasis blockchain. Misalnya, pada platform penyimpanan terdesentralisasi seperti Filecoin (FIL), pengguna perlu menggunakan token FIL untuk membayar penyimpanan data di jaringan. Dengan demikian, token utilitas berfungsi sebagai alat pembayaran internal yang memungkinkan pengguna mengakses layanan tertentu yang disediakan oleh platform tersebut.
              ...
              <div className="w-full dekstop:w-[48%] laptop:w-[48%] bg-gradient-to-r from-slate-50 via-gray-200 to-slate-50 p-4 dekstop:p-6 laptop:p-6 rounded-lg shadow-md">
            <h3 className="text-gray-800 text-xl dekstop:text-2xl laptop:text-2xl font-semibold mb-2">Partisipasi dalam Ekosistem atau Tata Kelola Platform</h3>
            <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base">
        ...
        <div className="w-full bg-white p-4 dekstop:p-6 laptop:p-4 rounded-lg shadow-md overflow-auto h-[300px] dekstop:h-[500px] laptop:h-[400px]">
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3">1. Pengertian Token Utilitas</h3>
         ...
         <span className='font-semibold'> Contoh Sederhana:</span> Anggaplah ada platform berbasis blockchain untuk berbagi konten musik, dan platform ini mengeluarkan token utilitas yang disebut MusicToken. Pengguna perlu membeli MusicToken untuk mengakses fitur-fitur premium, seperti streaming lagu tanpa iklan atau mengunduh lagu. MusicToken ini bukan investasi dalam platform, melainkan alat yang memungkinkan pengguna berinteraksi dengan platform tersebut.
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-3">2. Karakteristik Utama Token Utilitas</h3>
          ...
          <ul className='list-disc pl-6'>
           ...
           <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-4">3. Contoh Penggunaan Token Utilitas di Berbagai Industri</h3>
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-3">4. Cara Kerja Token Utilitas</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6 mt-2">
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xlmd:text-2xl font-semibold mb-3 mt-3">5. Keuntungan dari Token Utilitas</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6 mt-2">
          <ul className='list-disc pl-6'>
            <li className='mt-2'>
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-3">6. Tantangan dalam penggunaan Token Utilitas</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6 mt-2">
          <ul className='list-disc pl-6'>
            <li className='mt-2'>
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-3">7. Contoh Platform yang Mendukung Token Utilitas</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6 mt-2">
          <ul className='list-disc pl-6'>
            <li className='mt-2'>
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-3">8. Contoh Penggunaan Nyata Token Utilitas</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6 mt-2">
          <ul className='list-disc pl-6'>
            <li className='mt-2'>
