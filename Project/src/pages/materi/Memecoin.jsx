    ...
    <div className="min-h-screen w-full bg-gradient-to-r from-gray-900 via-purple-800 to-indigo-900 flex flex-col items-center justify-center p-4 dekstop:p-12 laptop:p-12">
      ...
      <div className="flex justify-center items-center h-[15vh]">
        <div className="h-[60px] w-[200px] dekstop:w-[500px] laptop:w-[400px] tablet:w-[300px] bg-slate-50 text-center rounded-2xl shadow-xl border-2 border-gradient-to-r from-purple-500 to-indigo-500 hover:shadow-indigo-500/50 transform hover:scale-105 transition duration-300 ease-in-out">
          <h1 className="text-black text-2xl dekstop:text-6xl laptop:text-5xl tablet:text-4xl font-extrabold gradient-judul tracking-wide">MEME COIN</h1>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center h-auto w-full dekstop:w-[1150px] laptop:w-[1000px] bg-slate-100 mt-6 dekstop:mt-12 laptop:mt-8 mb-12 p-4 dekstop:p-6 laptop:p-5 rounded-xl shadow-lg">
        <h2 className="text-gray-800 text-2xl dekstop:text-3xl laptop:text-2xl font-semibold mb-4 text-center">Apa itu Meme Coin ?</h2>
        ...
        <div className="w-[90%] max-w-[450px] h-[300px] dekstop:h-[450px] laptop:h-[350px] rounded-lg flex items-center justify-center mb-8 overflow-hidden">
         ...
         <div className="flex flex-wrap justify-around w-full gap-4 mb-6">
          <div className="w-full dekstop:w-[48%] laptop:w-[48%] bg-gradient-to-r from-slate-50 via-gray-200 to-slate-50 p-4 dekstop:p-6 laptop:p-6 rounded-lg shadow-md">
            <h3 className="text-gray-800 text-xl dekstop:text-2xl laptop:text-2xl font-semibold mb-2">Alat Spekulasi dan Investasi Jangka Pendek</h3>
          ...
          <div className="w-full dekstop:w-[48%] laptop:w-[48%] bg-gradient-to-r from-slate-50 via-gray-200 to-slate-50 p-4 dekstop:p-6 laptop:p-6 rounded-lg shadow-md">
            <h3 className="text-gray-800 text-xl dekstop:text-2xl laptop:text-2xl font-semibold mb-2">Membangun Komunitas dan Hiburan Sosial</h3>
            <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base">
        ...
        <div className="w-full bg-white p-4 md:p-6 rounded-lg shadow-md overflow-auto h-[300px] dekstop:h-[500px] laptop:h-[400px]">
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3">1. Pengertian Meme Coin</h3>
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-4">2. Karakteristik Utama Meme Coin</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6">
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xlfont-semibold mb-3 mt-4">3. Faktor-Faktor yang Mempengaruhi Harga Meme Coin</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6 mt-2">
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-4">4. Kegunaan Meme Coin</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6">
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-4">5. Kelebihan dan Kekurangan Meme Coin</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6">
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-4">6. Contoh Meme Coin Populer dan Pengaruhnya</h3>
          <p className="text-gray-700 text-sm dekstop:text-base laptop:text-base leading-relaxed ml-6">
          ...
          <h3 className="text-gray-800 text-lg dekstop:text-2xl laptop:text-2xl font-semibold mb-3 mt-4">7. Kesimpulan</h3>
