    ...
    <div className="min-h-screen w-full bg-gradient-to-r from-gray-900 via-purple-800 to-indigo-900 flex flex-col items-center justify-center p-4 md:p-8">
      ...
      <div className="flex justify-center items-center h-[15vh]">
        <div className="h-[80px] w-[90%] md:w-[500px] bg-slate-50 text-center rounded-2xl shadow-xl border-2 border-gradient-to-r from-purple-500 to-indigo-500 hover:shadow-indigo-500/50 transform hover:scale-105 transition duration-300 ease-in-out">
          <h1 className="text-black text-3xl md:text-5xl font-extrabold gradient-judul tracking-wide">SMART CONTRACT</h1>
        </div>
      </div>
      ...
      <div className="flex flex-col items-center h-auto w-full md:w-[1150px] bg-slate-100 mt-6 md:mt-12 mb-12 p-4 md:p-6 rounded-xl shadow-lg">
        <h2 className="text-gray-800 text-2xl md:text-3xl font-semibold mb-4 text-center">Apa itu Smart Contract ?</h2>
        ...
        <div className="w-[90%] max-w-[450px] h-[300px] md:h-[450px] rounded-lg flex items-center justify-center mb-8 overflow-hidden">
         ...
         <div className="flex flex-wrap justify-around w-full gap-4 mb-6">
          <div className="w-full md:w-[48%] bg-gradient-to-r from-slate-50 via-gray-200 to-slate-50 p-4 md:p-6 rounded-lg shadow-md">
            <h3 className="text-gray-800 text-xl md:text-2xl font-semibold mb-2">Otomatisasi dan Eksekusi Transaksi Tanpa Perantara</h3>
          ...
          <div className="w-full md:w-[48%] bg-gradient-to-r from-slate-50 via-gray-200 to-slate-50 p-4 md:p-6 rounded-lg shadow-md">
            <h3 className="text-gray-800 text-xl md:text-2xl font-semibold mb-2">Mendukung Aplikasi DeFi (Decentralized Finance)</h3>
            <p className="text-gray-700 text-sm md:text-base">
        ...
        <div className="w-full bg-white p-4 md:p-6 rounded-lg shadow-md overflow-auto h-[300px] md:h-[400px]">
          <h3 className="text-gray-800 text-lg md:text-2xl font-semibold mb-3">1. Pengertian Smart Contract</h3>
          ...
          <h3 className="text-gray-800 text-lg md:text-2xl font-semibold mb-3 mt-4">2. Karakteristik Utama Smart Contract</h3>
          ...
          <h3 className="text-gray-800 text-lg md:text-2xl font-semibold mb-3 mt-4">3. Fungsi dan Kegunaan Smart Contract di Berbagai Industri</h3>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed ml-6 mt-4">
          ...
          <p className="text-gray-700 text-sm md:text-base leading-relaxed ml-6 mt-2">
            ...
            <h3 className="text-gray-800 text-lg md:text-2xl font-semibold mb-3 mt-3">4. Cara Kerja Smart Contract</h3>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed ml-6 mt-2">
          ...
          <ul className='list-disc pl-6'>
            ...
            <h3 className="text-gray-800 text-lg md:text-2xl font-semibold mb-3 mt-3">5. Keuntungan Smart Contract</h3>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed ml-6 mt-2">
          <ul className='list-disc pl-6'>
            <li className='mt-2'>
            ...
            <h3 className="text-gray-800 text-lg md:text-2xl font-semibold mb-3 mt-3">6. Tantangan dan Risiko dalam Penggunaan Smart Contract</h3>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed ml-6 mt-2">
          <ul className='list-disc pl-6'>
            <li className='mt-2'>
            ...
            <h3 className="text-gray-800 text-lg md:text-2xl font-semibold mb-3 mt-3">7. Contoh Platform yang Mendukung Smart Contract</h3>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed ml-6 mt-2">
          <ul className='list-disc pl-6'>
            <li className='mt-2'>
            ...
            <h3 className="text-gray-800 text-lg md:text-2xl font-semibold mb-3 mt-3">8. Contoh Penggunaan Nyata Smart Contract</h3>
          <p className="text-gray-700 text-sm md:text-base leading-relaxed ml-6 mt-2">
          <ul className='list-disc pl-6'>
            <li className='mt-2'>
